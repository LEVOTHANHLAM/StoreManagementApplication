...
namespace PosManager.Forms.UserControls.Kho
{
    partial class NhapKhoUserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            dtgvAccount.Columns.AddRange(new DataGridViewColumn[] { cChon, cSTT, cMaPhieuNhapKho, cMaKho, cTenKho, cNgayNhap, cMaNhaCungCap, cTenNhaCungCap, cMaHoaDonNhap, cDelete, cEdit, cId });
            ...
            cMaNhaCungCap.Resizable = DataGridViewTriState.True;
            cMaNhaCungCap.SortMode = DataGridViewColumnSortMode.NotSortable;
            // 
            // cTenNhaCungCap
            // 

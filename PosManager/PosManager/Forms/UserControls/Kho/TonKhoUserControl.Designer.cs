...
{
    partial class TonKhoUserControl
    {
        /// <summary> 
        ...
        private void InitializeComponent()
        {
            ...
            cNgayNhap = new ComponentFactory.Krypton.Toolkit.KryptonDataGridViewDateTimePickerColumn();
            cHanSuDung = new ComponentFactory.Krypton.Toolkit.KryptonDataGridViewDateTimePickerColumn();
            ...
            panel4.Controls.Add(cbbKho);
            panel4.Location = new Point(483, 0);
            panel4.Name = "panel4";
            panel4.Size = new Size(434, 79);
            panel4.TabIndex = 11;
            // 
            // label4
            // 
            ...
            cbbKho.Font = new Font("Tahoma", 11.25F, FontStyle.Bold, GraphicsUnit.Point);
            cbbKho.FormattingEnabled = true;
            cbbKho.Items.AddRange(new object[] { "Admin", "Nhân Viên" });
            cbbKho.Location = new Point(73, 7);
            cbbKho.Name = "cbbKho";
            cbbKho.Size = new Size(350, 26);
            cbbKho.TabIndex = 37;
            ...
            label2.Location = new Point(126, 60);
            label2.Name = "label2";
            ...
            cbbCuonTrang.Location = new Point(65, 52);
            ...
            dtgvAccount.Columns.AddRange(new DataGridViewColumn[] { cSTT, cMaHangHoa, cTenHangHoa, cMaKho, cTenKho, cSoLuongTon, cMaDonViHangHoa, cTenDonViHangHoa, cNgayNhap, cHanSuDung, cDelete, cEdit, cId });
            ...
            cSoLuongTon.HeaderText = "Số Lượng Tồn";
            ...
            // cNgayNhap
            // 
            cNgayNhap.AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
            ...
            // cHanSuDung
            // 
            cHanSuDung.AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
            cHanSuDung.Checked = false;
            cHanSuDung.HeaderText = "Hạn Sử Dụng";
            cHanSuDung.Name = "cHanSuDung";
            cHanSuDung.Resizable = DataGridViewTriState.True;
            cHanSuDung.SortMode = DataGridViewColumnSortMode.Automatic;
            cHanSuDung.Width = 153;
            // 
            // cDelete
            // 
        ...
        private ComponentFactory.Krypton.Toolkit.KryptonDataGridViewDateTimePickerColumn cNgayNhap;
        private ComponentFactory.Krypton.Toolkit.KryptonDataGridViewDateTimePickerColumn cHanSuDung;

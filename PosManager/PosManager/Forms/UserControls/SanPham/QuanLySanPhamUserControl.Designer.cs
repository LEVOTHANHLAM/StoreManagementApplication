...
namespace PosManager.Forms.UserControls.SanPham
{
    partial class QuanLySanPhamUserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            btnAdd.TabIndex = 8;
            btnAdd.Values.Image = Properties.Resources.icons8_add_15;
            ...
            cbbCuonTrang.Location = new Point(62, 54);
            ...
            dtgvAccount.Columns.AddRange(new DataGridViewColumn[] { cChon, cSTT, cMaHangHoa, cTenHangHoa, cTenHangHoaKhongDau, cMaNhomHang, cTenNhomHang, cVAT, cGhiChu, cShow, cDelete, cId });
            ...
            // cVAT
            // 
            cVAT.AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
            cVAT.HeaderText = "VAT";
            cVAT.Name = "cVAT";
            // 
            // cGhiChu
            // 
            cGhiChu.AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;

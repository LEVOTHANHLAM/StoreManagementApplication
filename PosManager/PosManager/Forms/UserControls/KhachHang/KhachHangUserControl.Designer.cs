...
namespace PosManager.Forms.UserControls.KhachHang
{
    partial class KhachHangUserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            cPhoneNumber = new DataGridViewTextBoxColumn();
            cDiaChi = new DataGridViewTextBoxColumn();
            cNgaySinh = new ComponentFactory.Krypton.Toolkit.KryptonDataGridViewDateTimePickerColumn();
            cGioiTinh = new DataGridViewTextBoxColumn();
            cCapBac = new DataGridViewTextBoxColumn();
            ...
            splitContainer1.Size = new Size(1068, 421);
            ...
            panel4.Name = "panel4";
            panel4.Size = new Size(429, 81);
            panel4.TabIndex = 11;
            // 
            // btnExport
            // 
            btnExport.Location = new Point(290, 3);
            ...
            pDatagridView.Size = new Size(1068, 336);
            ...
            flowLayoutPanel1.Location = new Point(701, 0);
            ...
            lbThongBaoSoTrang.ForeColor = Color.Black;
            ...
            dtgvAccount.Columns.AddRange(new DataGridViewColumn[] { cSTT, cTen, cPhoneNumber, cDiaChi, cNgaySinh, cGioiTinh, cCapBac, cEdit, cDelete, cId });
            ...
            dtgvAccount.Size = new Size(1068, 336);
            ...
            // cPhoneNumber
            // 
            cPhoneNumber.AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
            cPhoneNumber.HeaderText = "SĐT";
            ...
            // cNgaySinh
            // 
            cNgaySinh.AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
            cNgaySinh.Checked = false;
            cNgaySinh.Format = DateTimePickerFormat.Short;
            cNgaySinh.HeaderText = "Ngày Sinh";
            cNgaySinh.Name = "cNgaySinh";
            cNgaySinh.Resizable = DataGridViewTriState.True;
            cNgaySinh.SortMode = DataGridViewColumnSortMode.Automatic;
            cNgaySinh.Width = 142;
            // 
            // cGioiTinh
            // 
            cGioiTinh.AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
            cGioiTinh.HeaderText = "Giới Tính";
            cGioiTinh.Name = "cGioiTinh";
            // 
            // cCapBac
            // 
            cCapBac.AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
            cCapBac.HeaderText = "Cấp Bậc";
            cCapBac.Name = "cCapBac";
            // 
            // cEdit
            // 
        ...
        private DataGridViewTextBoxColumn cPhoneNumber;
        private DataGridViewTextBoxColumn cDiaChi;
        private ComponentFactory.Krypton.Toolkit.KryptonDataGridViewDateTimePickerColumn cNgaySinh;
        private DataGridViewTextBoxColumn cGioiTinh;
        private DataGridViewTextBoxColumn cCapBac;
